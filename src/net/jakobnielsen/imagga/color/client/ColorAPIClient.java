...
public class ColorAPIClient extends APIClient {
    ...
    public ColorAPIClient(APIClientConfig apiConfig) {
        super(apiConfig, "colorsearchserver");
    }

   public List<ColorResult> colorsByUploadCode(String uploadCode) {
      Method method = new Method("imagga.colorsearch.extract");
      method.addParam("upload_code", uploadCode);
      method.addParam("delete_afterwards", TRUE_VALUE);
      ...
      method.addParam("extract_overall_colors", TRUE_VALUE);
      method.addParam("extract_object_colors", TRUE_VALUE);
